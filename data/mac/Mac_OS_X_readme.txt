...
Currently, we do not have this ID.  So you may get one of the following messages when trying to install or use Thunderpad:
"Thunderpad" can't be opened because it was not downloaded from the Mac App Store.
"Thunderpad" can't be opened because it is from an unidentified developer.
"Thunderpad" is damaged and can't be opened. You should move it to the Trash.


So, in order to unblock Thunderpad, please take the following steps:

1. Open up "Gatekeeper"
