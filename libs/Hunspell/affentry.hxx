...
class PfxEntry : public AffEntry {
    ...
    public:
        ...
        struct hentry *check_twosfx (const char *word, int len, char in_compound,
                                     const FLAG needflag = NULL);
...
class SfxEntry : public AffEntry {
    ...
    public:
        ...
        struct hentry *checkword (const char *word, int len, int optflags,
                                  ...
                                  const FLAG cclass = FLAG_NULL,
                                  const FLAG needflag = FLAG_NULL,
                                  const FLAG badflag = 0);

        struct hentry *check_twosfx (const char *word, int len, int optflags,
                                     AffEntry *ppfx, const FLAG needflag = NULL);

        char *check_twosfx_morph (const char *word, int len, int optflags,
                                  AffEntry *ppfx, const FLAG needflag = FLAG_NULL);
        struct hentry *get_next_homonym (struct hentry *he);
        struct hentry *get_next_homonym (struct hentry *word, int optflags,
