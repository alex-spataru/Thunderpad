...
struct cs_info iso1_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso2_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso3_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso4_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso5_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso6_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso7_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso8_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso9_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso10_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info koi8r_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info koi8u_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info cp1251_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso13_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso14_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iso15_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
struct cs_info iscii_devanagari_tbl[] = {{0x00, 0x00, 0x00},
    {0x00, 0x01, 0x01},
    {0x00, 0x02, 0x02},
    {0x00, 0x03, 0x03},
    {0x00, 0x04, 0x04},
...
static struct enc_entry encds[] = {{"ISO8859-1", iso1_tbl},
    {"ISO8859-2", iso2_tbl},
    {"ISO8859-3", iso3_tbl},
    {"ISO8859-4", iso4_tbl},
    {"ISO8859-5", iso5_tbl},
...
struct lang_map lang2enc[] = {{"ar", "UTF-8", LANG_ar},
    {"az", "UTF-8", LANG_az},
